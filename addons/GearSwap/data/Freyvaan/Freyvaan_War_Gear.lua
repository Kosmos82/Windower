function user_job_setup()
    ...
    state.OffenseMode:options('Normal','DW','Acc','FullAcc','Fodder')
    state.WeaponskillMode:options('Match','Normal','DW','Acc','FullAcc','Fodder')
	...
	state.Weapons:options('None','Naegling','Loxotic','Chango','Bravura','ShiningOne','Montante','Maliya','DualNaegling','DualLoxotic')

	gear.da_jse_back = {name="Cichol's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10','Damage taken-5%'}}
	gear.wsd_jse_back = {name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+7','Weapon skill damage +10%'}}
	gear.valorous_tp_head = {name="Valorous Mask", augments={'Accuracy+6','"Store TP"+7','DEX+4',}},
...
function init_gear_sets()
	...
	sets.precast.JA['Berserk'] = {back=gear.da_jse_back, feet="Agoge Calligae"}
	sets.precast.JA['Warcry'] = {head="Agoge Mask +1",}
	sets.precast.JA['Defender'] = {}
	sets.precast.JA['Aggressor'] = {body="War. Lorica +1"}
	...
	sets.precast.JA['Savagery'] = {head="Agoge Mask +1",}
	...
	sets.precast.WS['Red Lotus Blade'] = {
		...
		back="Toro Cape"}
	sets.precast.WS['Burning Blade'] = set_combine(sets.precast.WS['Red Lotos Blade'], {})
	sets.precast.WS['Seraph Blade'] = set_combine(sets.precast.WS['Red Lotos Blade'], {})
	sets.precast.WS['Sanguine Blade'] = set_combine(sets.precast.WS['Red Lotos Blade'], {head="Pixie hairpin +1", left_ring="Archon Ring"})

	sets.precast.WS.DW= set_combine(sets.precast.WS, {back="Letalis Mantle",})
    ...
    sets.precast.WS['Savage Blade'].DW= set_combine(sets.precast.WS.SomeAcc, {})
    sets.precast.WS['Savage Blade'].Acc = set_combine(sets.precast.WS.Acc, {})
    sets.precast.WS['Savage Blade'].FullAcc = set_combine(sets.precast.WS.FullAcc, {})
    sets.precast.WS['Savage Blade'].Fodder = set_combine(sets.precast.WS.Fodder, {})

    sets.precast.WS['Upheaval'] = set_combine(sets.precast.WS, {})
    sets.precast.WS['Upheaval'].DW= set_combine(sets.precast.WS.SomeAcc, {})
    ...
    sets.precast.WS['Resolution'].DW= set_combine(sets.precast.WS.SomeAcc, {})
    sets.precast.WS['Resolution'].Acc = set_combine(sets.precast.WS.Acc, {})
    sets.precast.WS['Resolution'].FullAcc = set_combine(sets.precast.WS.FullAcc, {})
    sets.precast.WS['Resolution'].Fodder = set_combine(sets.precast.WS.Fodder, {})
	
    sets.precast.WS['Ruinator'] = set_combine(sets.precast.WS, {})
    sets.precast.WS['Ruinator'].DW= set_combine(sets.precast.WS.SomeAcc, {})
    ...
    sets.precast.WS['Rampage'].DW= set_combine(sets.precast.WS.SomeAcc, {})
    ...
    sets.precast.WS['Raging Rush'].DW= set_combine(sets.precast.WS.SomeAcc, {})
    ...
    sets.precast.WS["Ukko's Fury"].DW= set_combine(sets.precast.WS.SomeAcc, {})
    ...
    sets.precast.WS["King's Justice"].DW= set_combine(sets.precast.WS.SomeAcc, {})
...
-- Ragnarok melee sets
	...
	sets.weapons.Maliya = {main="Maliya Sickle +1",sub="Utu Grip"}
	...
	sets.weapons.ProcClub = {main="Burrower's Wand",sub=empty}
	sets.weapons.ProcStaff = {main="Dark Staff",sub=empty}
