...
buff_spell_lists = {
	...
	AutoMelee = {
		{Name='Refresh III',	Buff='Refresh',		SpellID=894,	When='Engaged'},
		{Name='Haste II',		Buff='Haste',		SpellID=511,	When='Engaged'},
		{Name='Temper II',		Buff='Multi Strikes',SpellID=895,	When='Engaged'},
		{Name='Enthunder',		Buff='Enthunder',		SpellID=104,When='Engaged'},
		{Name='Aquaveil',		Buff='Aquaveil',		SpellID=55,	When='Engaged'},
	},
